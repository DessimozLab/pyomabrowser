(function (exports) {
  ...
  if (d3.event.sourceEvent && d3.event.sourceEvent.type === "brush") return; // ignore zoom-by-brush
     ...
     exports.bind_zoom = function (ref, container_overview, profiler_stack){
        ...
        var brush_xtent = [[margin.left, margin.top], [width - margin.right, height - margin.bottom]]
        ...
        var brushResizePath = function (d) {
            ...
            var e = +(d.type === "e"),
                x = e ? 1 : -1,
                y = height -margin.bottom -margin.bottom ;
        ...
        svg.selectAll(".handle--custom").attr("transform", function (d, i) {
                        return "translate(" + brush_xtent[i][0]  + "," + - margin.bottom  + ")";
                    });
    ...
    exports.visualize_headerxxxxxxxxx = function (id_container, data_profile, taxon , species ){

         var container_overview = document.getElementById(id_container);
    ...
    exports.visualize_headerxxxxxxxx = function (id, ref_profile_data, taxon, species) {

        var container_overview = document.getElementById(id);
        ...
        var data_profile = ref_profile_data;
    ...
    exports.visualizexxxxxxx = function(container, data, taxon_data, species_data){
        exports.run_profile_vis(container, data, taxon_data, species_data, margin, 200, 50);
    };


    exports.run_profile_visxxxxxxx = function (container, data_profile, taxon, species, margin, width, height) {
  ...
  if (d3.event.sourceEvent && d3.event.sourceEvent.type === "brush") return; // ignore zoom-by-brush
    ...
    exports.visualize_allxxxxxxx = function (profile_data, taxon_data, species_data, ref_profile_data) {
    ...
    exports.bind_brush_and_zoomxxxxx = function (minimap, array_chart) {
