...
urlpatterns = [
    ...
    # OMA Group
    url(r'^group/(?P<group_id>\w+)/$', RedirectView.as_view(pattern_name="omagroup_members", permanent=False), name='omagroup-old'),
    url(r'^group/(?P<group_id>\w+)/omagroup_members/$', RedirectView.as_view(pattern_name="omagroup_members", permanent=False), name="omagroup-old2"),
    ...
    url(r'^omagroup/(?P<group_id>\w+)/msa/$', views.OMAGroup_align.as_view(), name='omagroup_align'),
    url(r'^omagroup/(?P<group_id>\w+)/fasta/$', views.OMAGroupFasta.as_view(), name='omagroup-fasta'),
    ...
    url(r'^license/$', RedirectView.as_view(pattern_name="license"), name='red-license'),
    url(r'^terms_of_use/$', TemplateView.as_view(template_name='about_license.html'), name='license'),
