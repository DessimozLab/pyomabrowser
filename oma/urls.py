...
urlpatterns = [
    ...
    url(r'^homoeologs/(?P<entry_id>\w+)/fasta/$', views.HomoeologView.as_view(), name="homoeologs-fasta"),
    url(r'^homoeologs/(?P<entry_id>\w+)/json/$', views.HomoeologView.as_view(), name="homoeologs-json"),
